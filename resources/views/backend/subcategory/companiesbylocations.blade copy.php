		  ...
		  <tbody>
			@foreach(App\Models\District::orderBy('division_id', 'asc')->get() as $district)
				<tr>
					...
					<td>{{$district->companies->where('subcategory_id',$data->id)->count()}}</td>
				</tr>
			@endforeach
		  </tbody>
		</table>
		  ...
		  <tbody>
			@foreach(App\Models\Upazilla::orderBy('district_id', 'asc')->get() as $upazilla)
				<tr>
					...
					<td>{{$upazilla->companies->where('subcategory_id',$data->id)->count()}}</td>
				</tr>
			@endforeach
		  </tbody>
		</table>
		  ...
		  <tbody>
			@foreach(App\Models\Union::orderBy('upazilla_id', 'asc')->get() as $union)
				<tr>
					...
					<td>{{$union->companies->where('subcategory_id',$data->id)->count()}}</td>
				</tr>
			@endforeach
		  </tbody>
		</table>
